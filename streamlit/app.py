...
# Estilo CSS para ícones horizontal no desktop e rolagem no celular
st.markdown(
    """
    <style>
    .horizontal-icons {
...
if selected == 'About':
    ...
    with st.container():
        ...
        with col1:
            ...
            st.write("") 
            # Div para ícones horizontalmente ajustáveis
            st.markdown("<div class='horizontal-icons'>", unsafe_allow_html=True)
